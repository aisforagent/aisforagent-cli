...
The tool appends the provided `fact` to a special `AIFA.md` file located in the user's home directory (`~/.gemini/AIFA.md`). This file can be configured to have a different name.
