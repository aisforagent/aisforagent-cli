...
- `contextFileName`: The name of the file that contains the context for the extension. This will be used to load the context from the workspace. If this property is not used but a `AIFA.md` file is present in your extension directory, then that file will be loaded.
